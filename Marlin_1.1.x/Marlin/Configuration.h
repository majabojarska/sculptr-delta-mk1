...
#define STRING_CONFIG_H_AUTHOR "Maya" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Sculptr Delta"
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_RADIUS 65.0 // mm
  ...
  #define DELTA_DIAGONAL_ROD 155.0 // mm

  // height from z=0 to home position
  #define DELTA_HEIGHT 226.50 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 77.20 //mm  Get this value from auto calibrate
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -23.3  // Z offset: -below +above  [the nozzle]
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION   // Enable G26 mesh validation
    ...
    #define MESH_TEST_BED_TEMP       20.0   // (°C) Default bed temperature for the G26 Mesh Validation Tool.
  #endif
  ...
  #define UBL_PROBE_PT_2_X _PX(DELTA_PROBEABLE_RADIUS, 30)
  #define UBL_PROBE_PT_2_Y _PY(DELTA_PROBEABLE_RADIUS, 30)
  #define UBL_PROBE_PT_3_X _PX(DELTA_PROBEABLE_RADIUS, -30)
  #define UBL_PROBE_PT_3_Y _PY(DELTA_PROBEABLE_RADIUS, -30)
 ...
 */
#define Z_PROBE_END_SCRIPT "G1 X0 Y0 Z10 F6000"
